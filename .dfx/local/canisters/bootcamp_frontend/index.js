...
import { idlFactory } from './bootcamp_frontend.did.js';
export { idlFactory } from './bootcamp_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BOOTCAMP_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bootcamp_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bootcamp_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bootcamp_frontend.did.js")._SERVICE>}
 */
export const bootcamp_frontend = createActor(canisterId);
